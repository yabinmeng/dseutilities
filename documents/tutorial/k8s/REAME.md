...
4) Deploy a DSE cluster on GCP with XFS file system, external access to the DSE cluster, and dedicated GCP servcie account ([link](https://github.com/yabinmeng/dseutilities/blob/master/documents/tutorial/k8s/k8s_cass_operator_gke.md)).