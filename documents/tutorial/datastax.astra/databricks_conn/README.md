...
* First create an Azure Databricks Workspace
* Launch the workspace and we can create a Spark cluster in it.

The following [Azure document] (https://docs.microsoft.com/en-us/azure/databricks/scenarios/quickstart-create-databricks-workspace-portal?tabs=azure-portal) describes the details.


In this repo, the Spark cluster is based on the following runtime version:
