...
usage() {
   echo
   echo "Usage: genSelfSignSSL.sh [-h | <hostname_or_ip_list_file> <JKS|PKCS12>]"
   echo
}
...
WORKING_HOMEDIR_VAR=./SelfSignedSSL/$KEYSTORE_FILE_EXT
